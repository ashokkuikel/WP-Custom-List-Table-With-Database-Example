...
Version:     1.0
Author:      Ashok Kuikel
Author URI:  https://github.com/ashokkuikel/
License:     GPL2
 ...
 *
 * DROP TABLE IF EXISTS wp_customer_info;
...
function cltd_example_install()
{
    ...
    $table_name = $wpdb->prefix . 'customer_info'; // do not forget about tables prefix
 ...
 * http://codex.wordpress.org/Function_Reference/selecustomer_infod
 */
